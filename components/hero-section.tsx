			...
			<div className="mx-auto flex max-w-6xl flex-col items-center px-6 text-center">
				<div className="mx-auto flex max-w-4xl flex-col gap-0 md:gap-6">
					...
					<p className="mx-auto max-w-2xl text-balance text-muted-foreground lg:text-lg">
						Un petit investissement pour protéger un plus grand. Soyez serein et à l'affut en surveillant en
						temps réel tous les mouvements autour de tous vos biens.
					</p>
				</div>
