					...
					<div className="relative z-10 grid grid-cols-6 gap-3">
								...
								<div className="before:-inset-2 relative mx-auto flex aspect-square size-32 items-center rounded-full border before:absolute before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
									...
									>
										<g>
											...
											<circle
												className="animate-pulse fill-blue-500"
												cx="47.21"
												cy="15.7"
												r="2"
											/>
											...
											<circle className="fill-white" cx="38.67" cy="34.34" r="5" stroke="#000" />

											<circle className="fill-white" cx="38.67" cy="34.34" r="2" stroke="#000" />
										</g>
									</svg>
								</div>
								<div className="relative z-10 mt-6 space-y-2 text-center">
						...
						<Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
							<CardContent className="grid pt-6 sm:grid-cols-2">
								...
								<div className="-mx-6 relative mt-6 h-fit rounded-tl-(--radius) border-t border-l p-6 sm:ml-6">
									...
									>
										...
										<defs>
											...
											>
												...
												<stop offset="1" stopColor="#2d7fff" stopOpacity="0.01" />
											</linearGradient>
										</defs>
									</svg>
								</div>
